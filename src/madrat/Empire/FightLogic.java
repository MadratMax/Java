...
public class FightLogic {
    ...
    public static void fight(Army army1, Army army2) {
        ...
        // TODO
        // FIGHT
        MessageBox.pushFightMessage("Soldier " + soldier1.name() + " [land: " + army1.owner().name() + "] will fight " + soldier2.name());
        MessageBox.pushFightMessage("Soldier " + soldier1.name() + " health: " + soldier1.health());
        MessageBox.pushFightMessage("Soldier " + soldier2.name() + " health: " + soldier2.health());
        ...
        if (sol1Score > 0) {
            MessageBox.pushFightMessage("Soldier " + soldier1.name() + " [land: " + army1.owner().name() + "] harmed " + soldier2.name() + " with power " + sol1Score);
        ...
        if (soldier1.health() > 0) {
            ...
            MessageBox.pushFightMessage("Soldier " + soldier1.name() + " [land: " + army1.owner().name() + "] was killed by " + soldier2.name());
            ...
            MessageBox.pushMessage("army " + army1.owner().name() + " lost its soldier");
        }
        ...
        if (soldier2.health() > 0) {
            ...
            // TODO message if my L -> your sold. was killed
            MessageBox.pushFightMessage("Soldier " + soldier2.name() + " [land: " + army2.owner().name() + "] was killed by " + soldier1.name());
            ...
            MessageBox.pushMessage("army " + army2.owner().name() + " lost its soldier");
        }
    }
}
